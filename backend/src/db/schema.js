...
export const deliveryZoneStatus = pgEnum("delivery_zone_status", [
    "active",
    "inactive",
    "maintenance",
]);
...
export const orders = pgTable("orders", {
    ...
    deliveryFee: numeric("delivery_fee", { precision: 8, scale: 2 }).default(
        "0.00"
    ),
...
export const customers = pgTable("customers", {
    ...
    totalSpent: numeric("total_spent", { precision: 10, scale: 2 }).default(
        "0.00"
    ),
...
export const deliveryZones = pgTable("delivery_zones", {
    ...
    estimatedDeliveryTime: integer("estimated_delivery_time")
        .default(10)
        .notNull(),
    baseDeliveryFee: numeric("base_delivery_fee", {
        precision: 8,
        scale: 2,
    }).default("0.00"),
    status: deliveryZoneStatus("status").default("active").notNull(),
