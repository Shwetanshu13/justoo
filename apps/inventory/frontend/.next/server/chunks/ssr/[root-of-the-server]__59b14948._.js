...
"[project]/apps/inventory/frontend/src/lib/api.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/inventory/frontend/src/contexts/AuthContext.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = ({ children })=>{
    ...
    const checkAuth = async ()=>{
        try {
            const token = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$js$2d$cookie$40$3$2e$0$2e$5$2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('token');
            if (token) {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$inventory$2f$frontend$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get('/auth/profile');
    ...
    const login = async (username, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$inventory$2f$frontend$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/login', {
                username,
                password
            });
            const { token, user } = response.data.data;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$js$2d$cookie$40$3$2e$0$2e$5$2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set('token', token, {
                expires: 7
            });
            setUser(user);
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$inventory$2f$frontend$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/logout');
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59b14948._.js.map